import{_ as s}from"./chunks/shouye.fad50a61.js";import{_ as n,o as a,c as l,Q as p}from"./chunks/framework.a767a766.js";const h=JSON.parse('{"title":"使用案例","description":"","frontmatter":{},"headers":[],"relativePath":"docs/api/demo.md","filePath":"docs/api/demo.md"}'),e={name:"docs/api/demo.md"},o=p('<h1 id="使用案例" tabindex="-1">使用案例 <a class="header-anchor" href="#使用案例" aria-label="Permalink to &quot;使用案例&quot;">​</a></h1><p>表格查询是系统中常见的开发场景，接下来我们通过示例演示如何将高频代码转换成低代码，并进行联动。</p><img src="'+s+`"><h2 id="表单" tabindex="-1">表单 <a class="header-anchor" href="#表单" aria-label="Permalink to &quot;表单&quot;">​</a></h2><p>首先准备一个表单组件，然后对外暴漏一个获取表单参数的方法</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">const getForm = () =&gt; {}</span></span>
